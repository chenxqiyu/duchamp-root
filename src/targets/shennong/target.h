...
#define DIRECT_MAP_BASE 0xffffff8080000000ULL /* √ 完全确认:=PAGE_OFFSET+phys 0x80000000 */
#define DIRECT_MAP_END 0xffffff9000000000ULL /* √ 完全确认:=PAGE_OFFSET+64GB */
#define VMEMMAP_START 0xfffffffe00000000ULL /* √ 完全确认:宏链 -(1UL<<33) 且反证 struct page=64B */
...
#define INIT_TASK_OFF 0x01fef600ULL /* √ 完全确认:p0 profile 日志逐位验证 */
#define INIT_UTS_NS_OFF 0x02171eb0ULL
#define EMPTY_ZERO_PAGE_OFF 0x021d0000ULL
#define ROOT_TASK_GROUP_OFF 0x021d7580ULL /* √ 完全确认:p0 profile 日志逐位验证 */
...
#define SLIDE_NFULNL_LOGGER_OFF 0x01fe29c8ULL /* √ 完全确认:p0 profile 日志逐位验证 */
#define SLIDE_LOGGERS_0_1_OFF 0x01fe2910ULL
#define SLIDE_RANDOM_BOOT_ID_DATA_OFF 0x0224a458ULL /* √ 完全确认:p0 profile 日志逐位验证 */
#define SLIDE_INIT_TASK_OFF INIT_TASK_OFF
#define SLIDE_ROOT_TASK_GROUP_OFF ROOT_TASK_GROUP_OFF
#define SLIDE_SYSCTL_BOOTID_OFF 0x0224a458ULL /* √ 完全确认:p0 profile 日志逐位验证(与BOOT_ID_DATA同址) */
...
#define STRUCT_PAGE_SIZE 0x40 /* √ 完全确认:VMEMMAP_START=-(1UL<<33) 反证 struct page=64B */
